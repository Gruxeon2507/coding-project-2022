...
function Dialogs.RegisterDialogue()
    ...
    API.AddText(id, "Salut!", WAVE_ANIMATION)
    API.AddText(id, "comment tu va?")

    API.AddOption(id, "bien.", "GenericConversation2")
    API.AddOption(id, "super!", "GenericConversation3")

    id = "GenericConversation2"
    API.RegisterDialogueId(id)
    API.AddText(id, "Nickel ,ici se trouve le coin de vente d'arme", "unarmed_yes")
